 ...
 * on 2016-11-13 at 18:22:01 UTC 
 * Modify at your own risk.
 */

package com.example.abhiroj.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://fir-app-776ba.appspot.com/_ah/api/";
   ...
   * @return the request
   */
  public FetchJoke fetchJoke() throws java.io.IOException {
    FetchJoke result = new FetchJoke();
    initialize(result);
    return result;
  }

  public class FetchJoke extends MyApiRequest<com.example.abhiroj.myapplication.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link FetchJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     ...
     */
    protected FetchJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.abhiroj.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.abhiroj.myapplication.backend.myApi.model.MyBean> {
